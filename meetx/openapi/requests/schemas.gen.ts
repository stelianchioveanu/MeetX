...
export const $ErrorCodes = {
    enum: ['Unknown', 'TechnicalError', 'EntityNotFound', 'PhysicalFileNotFound', 'UserAlreadyExists', 'WrongPassword', 'CannotAdd', 'CannotUpdate', 'CannotDelete', 'MailSendFailed', 'TagAlreadyExists', 'WrongTag', 'WrongInputs', 'TokenExpired', 'GroupAlreadyExists', 'NotAnAdmin', 'NotAnAppAdmin', 'NotAMember', 'WrongName', 'WrongEmail', 'WrongIndustry', 'UserNotFound', 'BadCredentials', 'GroupNotFound', 'WrongTitle', 'WrongPosition', 'WrongDescription', 'ConvNotFound', 'TopicNotFound', 'WrongMessage', 'ContactNotFound', 'NotFromStaff'],
    type: 'string'
} as const;
